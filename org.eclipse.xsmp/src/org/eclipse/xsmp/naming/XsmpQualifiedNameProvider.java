...
import static org.eclipse.xsmp.xcatalogue.XcataloguePackage.Literals.PATH__SEGMENT;
...
public class XsmpQualifiedNameProvider extends IQualifiedNameProvider.AbstractImpl
{
  ...
  protected QualifiedName computeFullyQualifiedName(final AbstractPath path)
  {
    ...
    if (result != null)
    {
      switch (path.eClass().getClassifierID())
      {
        ...
        case XcataloguePackage.STRING_PATH:
        {
  ...
  {
    if (obj instanceof final Instance instance)
    {
      return computeFullyQualifiedName(instance);
    }
